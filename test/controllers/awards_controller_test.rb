...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { date: @award.date, description: @award.description, name: @award.name, user_id: @award.user_id }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { date: @award.date, description: @award.description, name: @award.name, user_id: @award.user_id }
    assert_redirected_to award_path(assigns(:award))
  end
